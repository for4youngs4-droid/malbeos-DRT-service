    ...
    >
      <div className="flex flex-1 flex-col items-center justify-center gap-9">
        <div className="relative flex h-40 w-40 items-center justify-center">
          <span aria-hidden className="breathe absolute h-40 w-40 rounded-full bg-white/10" />
          <span aria-hidden className="wave-ring absolute h-40 w-40 rounded-full border border-white/40" style={{ animationDelay: "0s" }} />
