...
export default function Toggle({ checked, onChange, label }: Props) {
  return (
    <button
      ...
      className={`relative h-8 w-14 shrink-0 rounded-pill transition ${checked ? "bg-brand shadow-[inset_0_2px_5px_rgba(15,37,64,0.35)]" : "bg-[#d3deea] shadow-[inset_0_2px_5px_rgba(15,37,64,0.2)]"}`}
    >
      <span
